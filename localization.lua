...
if ( GetLocale() == "koKR" ) then
	FHH_ARCANE_RESIST = "비전 저항력";
	FHH_FIRE_RESIST = "화염 저항력";
	FHH_FROST_RESIST = "냉기 저항력";
	FHH_NATURE_RESIST = "자연 저항력";
	FHH_SHADOW_RESIST = "암흑 저항력";
	-- So, our reverse mapping represents any of the five resistances.
	FHH_ALL_RESISTS = "비전/화염/냉기/자연/암흑 저항력";
	...
	FHH_POISON = "전갈독";
	FHH_PROWL = "숨기";
	FHH_SCREECH = "날카로운 울음소리";
	FHH_CHARGE = "돌진";
	FHH_SHELL = "껍질 방패";
	FHH_THUNDERSTOMP = "천둥벼락";
